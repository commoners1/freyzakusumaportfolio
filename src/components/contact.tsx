...
export function Contact() {
  return (
    <section id="contact" className="w-full py-12 md:py-24 lg:py-32 bg-background/80 backdrop-blur-md scroll-mt-16">
      <div className="container grid items-center justify-center gap-8 px-4 md:px-6 lg:grid-cols-2 lg:gap-16 mx-auto">
        <div className="space-y-6 text-center animate-in fade-in slide-in-from-left-12 duration-1000 lg:text-left">
