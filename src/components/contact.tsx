            ...
            <div className="flex items-center gap-4 justify-center lg:justify-start">
             ...
             <div className="flex items-center gap-4 justify-center lg:justify-start pt-4">
                <Link href="#" prefetch={false}>
                    <Github className="h-8 w-8 text-foreground hover:text-primary transition-colors" />
                </Link>
                <Link href="#" prefetch={false}>
                    <Linkedin className="h-8 w-8 text-foreground hover:text-primary transition-colors" />
                </Link>
             </div>
          </div>
        </div>
        <div className="w-full max-w-md mx-auto animate-in fade-in slide-in-from-right-12 duration-1000">
            <ContactForm />
        </div>
      </div>
    </section>
